...
def test_parse_transfer_narrative_uses_cleaned_final_segment() -> None:
    raw = (
        "Abbuchung Lastschrift|Reference 123|BAWAATWWXXX AT121200050660059007 A1 Telekom Austria AG"
    )
...
def test_parse_narrative_dispatches_transfer_narratives() -> None:
    raw = "Abbuchung Onlinebanking|AT121200050660059007 Hutchison Drei Austria GmbH"
...
def test_card_parser_recognizes_legacy_quick_l_cash_withdrawal() -> None:
    raw = "Bezahlung Karte MC/000000338|QUICK-L   00018872 K001 03.05. 11:21"
